...
## Access Communities
The `get_community()` accesses the community data and takes only the required argument _foodwebID_.
Specifying too many foodwebIDs results in hitting the limit of the URL length (most likely when `get_community()` queries the taxon list).
```{r communities-0}
tryCatch(
